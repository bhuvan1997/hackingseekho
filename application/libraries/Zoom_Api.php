...
require_once APPPATH . 'third_party/php-jwt-master/src/BeforeValidException.php';
require_once APPPATH . 'third_party/php-jwt-master/src/ExpiredException.php';
require_once APPPATH . 'third_party/php-jwt-master/src/SignatureInvalidException.php';
...
class Zoom_Api
{
	private $zoom_api_key = 'ayaOaLgBRG-saJE1yl5hTg';
	private $zoom_api_secret = 'sPCL5mzt3CGmHUZODVyNObpbtfTMVUHDJVYt';	
	...
	//function to send request
    	...
    	{
		//Enter_Your_Email
		$request_url = "https://api.zoom.us/v2/users/bhuvan.veritos@gmail.com/meetings";
