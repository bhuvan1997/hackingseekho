        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            ...
            <?php } ?>
              ...
              <p style="text-align: center; font-size: xx-large; font-family: fantasy; color:#4b49acc4;">STUDENT &nbsp; SIGNUP</p>
              <form class="pt-3"  action="<?php echo base_url('user/Signup'); ?>" method="POST">
              ...
              <div class="form-group">
                ...
                <div class="text-center mt-4 font-weight-light">
                  Already have an account? <a href="<?php echo base_url('user/Signin'); ?>" class="text-primary">Login</a>
                </div>
              </form>
            </div>
          </div>
